...
if ($request->get('ORDER_ID') <> '') {
    ...
    <div class="container peterburg" style="position: relative;">
    ...
    <script>
		...
		var chosen_city_geoposition = "<?php echo $city; ?>";
		var chosen_city_real_geoposition = "<?php echo $city; ?>";
