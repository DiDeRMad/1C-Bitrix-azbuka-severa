        ...
        <div class="container">
            <div class="inner-header__wrapper">
                ...
                <div class="inner-header__caption">
                    <h1 class="caption--h1">Корзина</h1>
                    <p id="count_items" data-count="<?= $arResult['BASKET_ITEMS_COUNT']?>" class="inner-header__caption-description"><?= num_word($arResult['BASKET_ITEMS_COUNT'], ['товар', 'товара', 'товаров'])?></p>
                </div>

                <div class="inner-header__after-line">
                    <a class="inner-header__clear-cart js-clear-cart" href="#!">Очистить корзину</a>

                    <div class="clear-modal">
                        <p class="clear-modal__caption">Очистить корзину?</p>
                        <p class="clear-modal__description">Товары вернутся обратно на полки</p>
                        <div class="clear-modal__btn-wrapper">
                            <a href="<?=$APPLICATION->GetCurPageParam('clear')?>" class="btn btn--outline">Очистить</a>
        ...
        <div class="cart">
            <div class="cart__wrapper">
                <div class="cart__content">
                    <div class="cart-product-list__wrapper">
                        <div id="basket-item-table" class="cart-product-list">
                            
                        </div>
                        <div class="cart-content__btn-wrapper">
                            <?php global $USER?>
                            <a <?php if(!empty($USER->GetID())):?>href="/order/"<?else:?>href="/login/"<?endif;?>  class="btn btn--green cart-content__btn">Оформить заказ</a>
                        </div>
                    </div>
                </div>
