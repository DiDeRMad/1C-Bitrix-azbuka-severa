...
foreach ($arResult['SECTIONS'] as $key => &$arSection) {
    ...
    $arSection['PICTURE']['SRC_1X'] = CFile::ResizeImageGet($arSection['PICTURE']['ID'], array('width'=> 250, 'height'=> 200), BX_RESIZE_IMAGE_PROPORTIONAL, true)['src'];
    $arSection['PICTURE']['SRC_1X_WEBP'] = webpExtension($arSection['PICTURE']['SRC_1X']);
    $arSection['PICTURE']['SRC_2X'] = CFile::ResizeImageGet($arSection['PICTURE']['ID'], array('width'=> 250 * 2, 'height'=> 200 * 2), BX_RESIZE_IMAGE_PROPORTIONAL, true)['src'];
    $arSection['PICTURE']['SRC_2X_WEBP'] = webpExtension($arSection['PICTURE']['SRC_2X']);
